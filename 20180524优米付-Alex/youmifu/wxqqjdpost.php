...
$data['choosePayType'] = "5"; //5.微信扫码
if(_is_mobile()){
    $data['apiName'] =  "WAP_PAY_B2C";
    $data['choosePayType'] = "13"; //13.微信H5(WAP_PAY_B2C)
}
if (strstr($pay_type, "京东钱包")) {
    $scan = "jd";
    $payType = $pay_type . "_jd";
    $bankname = $pay_type . "->京东钱包在线充值";
    $data['choosePayType'] = "8"; //8.京东扫码
    if(_is_mobile()){
        $data['apiName'] =  "WEB_PAY_B2C";//不是wap
        $data['choosePayType'] = "21"; //21.京东H5 WEB_PAY_B2C
    }
}elseif (strstr($pay_type, "QQ钱包") || strstr($pay_type, "qq钱包")) {
    $scan = "qq";
    $payType = $pay_type . "_qq";
    $bankname = $pay_type . "->QQ钱包在线充值";
    $data['choosePayType'] = "6"; //6.QQ扫码
    if(_is_mobile()){
        $data['apiName'] =  "WAP_PAY_B2C";//
        $data['choosePayType'] = "15"; //15.QQ H5(WAP_PAY_B2C)
    }
}
