package com.great.ssm.controller;
...
public class HelloController {
    ...
    Map weixin(@RequestBody String jsonObj) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        String return_type = jsonObject.getString("return_type");//支付金额
		
		String api_code = "34393032";//测试商户号
		String api_key = "d57a2b05447e305a0f67ff0e5627cc86";//测试签名秘钥
		
        //String api_code = jsonObject.getString("api_code");//商户号
        //String api_key = jsonObject.getString("api_key");//签名秘钥
		
        String price = jsonObject.getString("price");//订单定价
        ...
        for (byte b : md.digest()) {
            bufs.append(String.format("%02x", b & 0xff));
        }
        String md5 = bufs.toString();
        //将字符串全部转为大写
    ...
    public @ResponseBody
    Map paynotify(@RequestBody String jsonStr) throws NoSuchAlgorithmException, IOException {
