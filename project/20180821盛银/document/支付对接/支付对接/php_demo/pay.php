 ...
 */
	...
	$api_code = empty($_POST["api_code"]) ? "商户号" : $_POST["api_code"];	//此处填写商户的id;
	$api_key = empty($_POST["api_key"]) ? "秘钥" : $_POST["api_key"];	//此处填写的密钥;			
    ...
    $return_url = 'http://ip地址/paytest/payreturn.php';//支付成功，用户会跳转到这个地址
    $notify_url = 'http://ip地址/paytest/paynotify.php';//通知异步回调接收地址
