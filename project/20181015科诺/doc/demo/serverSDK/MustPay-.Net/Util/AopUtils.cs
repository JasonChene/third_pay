...
namespace mustpay.Util
{
    ...
    /// </summary>
        ...
        {
            return MustpayEncrypt.AesEncrypt(encryptKey, bizContent, charset);

        }

        /// <summary>
        /// 给AOP请求签名。
        /// <remarks>建议使用<code>MustpaySignature.RSASign(parameters, privateKeyPem)</code>></remarks>
        /// </summary>
        ...
        {
            return MustpaySignature.RSASign(parameters, privateKeyPem, charset, signType);
        }
        ...
        {
            return MustpaySignature.RSASign(parameters, privateKeyPem, charset, keyFromFile,signType);
        }
