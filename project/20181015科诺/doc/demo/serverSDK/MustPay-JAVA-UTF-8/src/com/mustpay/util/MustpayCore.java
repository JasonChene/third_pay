...
public class MustpayCore {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(MustpayConfig.SIGN_TYPE.equals("RSA") ){
        	mysign = RSA.sign(prestr, MustpayConfig.MER_PRIVATE_KEY, MustpayConfig.INPUT_CHARSET);
        }
        return mysign;
    }
    ...
    public static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = parasFilter(sParaTemp);
        //生成签名结果
        String mysign = buildRequestMysign(sPara);

        //签名结果与签名方式加入请求提交参数组中
        sPara.put("sign", mysign);
        sPara.put("sign_type", MustpayConfig.SIGN_TYPE);
