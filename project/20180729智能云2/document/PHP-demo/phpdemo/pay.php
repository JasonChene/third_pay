...
$post["uid"] = $uid;
$post["price"] = $_REQUEST["price"];//金额最末位不得为0
...
$return = curl_post_https($url, $post);
...
<div class="body">
    ...
    <div class="mod-ct">
        ...
        <div class="amount" id="money">￥<?php echo $info["data"]["realprice"]; ?></div>
        ...
        <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
            <div data-role="qrPayImg" class="qrcode-img-area">
                ...
                <div style="position: relative;display: inline-block;">
                    ...
                    <img onclick="$('#use').hide()" id="use" src="images/logo_<?php if($post["istype"] == 10001){echo "alipay";}else{echo "weixin";} ?>.png" style="position: absolute;top: 50%;left: 50%;width:32px;height:32px;margin-left: -16px;margin-top: -16px"/>
        ...
        <div class ="payweixinbtn" style = "display: none;"><a href="https://pan.baidu.com/share/qrcode?w=210&h=210&url=<?php echo $info["data"]["qrcode"]; ?>" target="_blank" download id="downloadbtn" class="btn btn-primary">1.先保存二维码到手机</a></div>
        ...
        <div class="time-item" style = "padding-top: 10px">
            <div class="time-item" id="msg"><h1 style="color: red;">为了您及时到帐 请务必付款￥<?php echo $info["data"]["realprice"]; ?>元</h1> </div>
