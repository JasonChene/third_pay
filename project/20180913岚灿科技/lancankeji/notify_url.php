...
$mymoney = number_format($data['payAmt'], 2, '.', ''); //订单金额
$success_msg = $data['retCode'];//成功讯息
...
#验签方式
$signtext = "orderNo=" . $data['orderNo'] . "&payAmt=" . $data['payAmt'] . "&retCode=" . $data['retCode'] . "&transNo=" . $data['transNo'] . "&userId=" . $data['userId'] . "&key=" . $pay_mkey;//验签字串
