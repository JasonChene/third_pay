...
public class WalletWithDrawQueryDemo extends BaseDemo {

    public static Logger logger = LoggerFactory.getLogger(WalletWithDrawQueryDemo.class);

    public String query(WalletWithDrawQueryReqModel reqModel) {
        String url = ServerConfig.reqUrl + ServerConfig.withdrawQueryPath;
