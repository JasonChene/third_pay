...
public class KuaiJieDemo extends BaseDemo {

    public static Logger logger = LoggerFactory.getLogger(KuaiJieDemo.class);

    public String fastSign(KuaiJieReqModel kuaiJieReqModel) {
        String url = ServerConfig.reqUrl + ServerConfig.fastsignPath;
