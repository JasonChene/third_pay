        ...
        <table class="style1">
            <tr>
                <td class="style2">
                    提交地址:</td>
                <td class="style3">
                    <asp:TextBox ID="txtUrl" runat="server" Width="400px" Text="http://pay.mengbaof88.com/gateway.html"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2">
            ...
            <tr>
                <td class="style2">
                    银行类型:</td>
                <td class="style3">
                    <asp:TextBox ID="txtbanktype" runat="server">WEIXINWAP</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2">
                    订单金额:</td>
                <td class="style3">
                    <asp:TextBox ID="txtpaymoney" runat="server">1.00</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2">
            ...
            <tr>
                <td class="style2">
                    异步通知地址:</td>
                <td class="style3">
                    <asp:TextBox ID="txtcallbackurl" runat="server" Width="362px">http://www.youdomain.com/callback.aspx</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2">
                    同步跳转地址:</td>
                <td class="style3">
                    <asp:TextBox ID="txthrefbackurl" runat="server" Width="362px">http://www.youdomain.com/jump.aspx</asp:TextBox>
                </td>
            </tr>
                        <tr>
                <td class="style2">
