...
#固定参数设置
$form_url = 'http://saas.yeeyk.com/saas-trx-gateway/order/acceptOrder';
...
#第三方传值参数设置
$data = array(
"trxMerchantNo" => $pay_mid,
"trxMerchantOrderno" => $order_no,
"requestAmount" => $MOAmount,
"noticeSysaddress" => $notify_url,
"memberGoods" => $order_no,
"noticeWebaddress" => $return_url,
"productNo" => 'QUICKPAY-JS',
"cerdNo" => $S_Name,
"hmac" => array(
"str_arr" => array(
"memberGoods" => $order_no,
