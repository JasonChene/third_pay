...
<html>
  ...
  <body>
	<form method="post" action="B2CPay.jsp" target="_blank">
		<br>商 家 号(merchant_code)：<input Type="text" Name="merchant_code" value="Z800001001001"> *		
		...
		<br>服务器异步通知地址(notify_url)：<input Type="text" Name="notify_url" value="http://localhost:8080/Test11/offline_notify.jsp"> *																							
		<br>签名方式(sign_type)：
		...
		<!--以下参数为可选参数  -->
		<br>页面跳转同步通知地址(return_url)：<input Type="text" Name="return_url" value="http://localhost:8080/Test11/page_notify.jsp"> 
		...
		<br><input Type="submit" Name="submit" value="支付">
	</form>
  </body>
</html>
