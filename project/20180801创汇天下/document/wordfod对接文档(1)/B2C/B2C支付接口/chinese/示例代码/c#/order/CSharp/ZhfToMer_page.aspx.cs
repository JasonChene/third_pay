...
namespace CSharp
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
			...
			string orginal_money = Request.Form["orginal_money"];
            ...
            **/
            ...
            signStr = signStr + "interface_version" +orginal_money+ "&";
            ...
            if (sign_type == "RSA-S") //RSA-S的验签方法
            {
                ...
                string zhf_public_key = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCd4i4BtmXnogBHxB0j6jCcmW4YvZgCE9UKBNbEiKAe4RfzeylNo9f3uT/ceJA1/hG/x/ZmfsUtKwOwOe14uYQt9RuaFfu3FE/daMqC63wQmMIQox3HZ0b0BwefO1ax7Tjl3aW0QGQTzy4dZVLhfqoxVALGiE84CwRC2/S6y/cWfQIDAQAB";
                //将公钥转换成C#专用格式
            ...
            else //RSA验签方法
            {
                ...
                bool result = rsaWithH.VerifySign("1111110166", signStr, zhfsign);
                if (result == true)
                {
                    //注：建议页面同步通知一般只做订单支付成功提示，而不做订单支付状态更新，更新订单支付状态在notify_url指定的地址处理，请做好订单是否重复修改状态的判断，以免虚拟充值重复到账！！
                    Response.Write("验签成功");
