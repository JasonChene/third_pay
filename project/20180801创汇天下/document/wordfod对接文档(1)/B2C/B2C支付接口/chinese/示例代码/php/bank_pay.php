...
?>
<!-- 以post方式提交所有接口参数到支付网关https://pay.wordfod.com/gateway?input_charset=UTF-8 -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	</head>	
	<body onLoad="document.zhihpayForm.submit();">
		<form name="zhihpayForm" method="post" action="https://pay.wordfod.com/gateway?input_charset=UTF-8" target="_blank">
