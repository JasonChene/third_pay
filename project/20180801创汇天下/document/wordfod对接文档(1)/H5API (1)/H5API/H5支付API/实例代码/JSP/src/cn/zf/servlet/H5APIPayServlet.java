...
public class H5APIPayServlet extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {	
		...
		// 支付请求地址
		String reqUrl = "https://api.huayinpay.com/gateway/api/h5apipay";
		...
		if("RSA".equals(sign_type)){ // 数字证书加密方式 sign_type = "RSA"
			...
			reqMap.put("sign", sign);				
			result= new HttpClientUtil().doPost(reqUrl, reqMap, "utf-8");				// 向华银发送POST请求
		}
