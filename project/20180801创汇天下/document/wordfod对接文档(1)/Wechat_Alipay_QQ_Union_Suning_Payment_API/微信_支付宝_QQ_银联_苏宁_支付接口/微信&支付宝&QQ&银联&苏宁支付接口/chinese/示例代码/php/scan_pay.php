...
*/
	...
	$service_type = $_POST["service_type"];//微信：weixin_scan 支付宝：alipay_scan 
...
/**
curl方法提交支付参数到网关https://api.wordfod.com/gateway/api/scanpay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.wordfod.com/gateway/api/scanpay");
...
/////////////////////////////   获取qrcode，并生成二维码  /////////////////////
/**
解析返回参数，获取qrcode的值，并且根据这个值生成二维码
*/
