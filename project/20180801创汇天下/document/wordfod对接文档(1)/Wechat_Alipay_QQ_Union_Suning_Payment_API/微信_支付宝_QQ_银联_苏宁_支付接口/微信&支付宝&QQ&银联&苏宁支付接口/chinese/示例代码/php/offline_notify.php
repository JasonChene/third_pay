...
*/	
	...
	$zhihpaySign = base64_decode($_POST["sign"]);
	...
	$orginal_money = $_POST["orginal_money"];
...
*/
	...
	$signStr = $signStr."order_time=".$orginal_money."&";
...
/////////////////////////////   RSA-S验签  /////////////////////////////////
	...
	$zhihpay_public_key = openssl_get_publickey($zhihpay_public_key);	
