  ...
  <body>
	<table>
		<tr>
  			<td>
  				<form id="SMpay">
					<div>商 家 号(merchant_code)：<input Type="text" Name="merchant_code" id="merchant_code" value="Z800001001001"> * </div>
					<div>业务类型(service_type)：
						<select name="service_type" id="service_type">
							<option value="weixin_scan">weixin_scan</option>
							<option value="alipay_scan">alipay_scan</option>
							<option value="tenpay_scan">qq_scan</option>
						</select> *	</div>
					...
					<div>商户订单总金额(order_amount)：<input Type="text" Name="order_amount" id="order_amount" value="1.00"> * </div>		
