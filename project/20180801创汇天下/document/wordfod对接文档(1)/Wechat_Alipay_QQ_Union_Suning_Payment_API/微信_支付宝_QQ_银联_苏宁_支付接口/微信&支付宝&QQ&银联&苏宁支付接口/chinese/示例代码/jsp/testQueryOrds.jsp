  ...
  <body>
  	<table>
		<tr>
  			<td>
				<form id="queryords">
					<div>商 家 号(merchant_code)：<input Type="text" Name="merchant_code" id="merchant_code" value="800001001002"> * </div>
					...
					<div>交易订单号(trade_no)：<input Type="text" Name="trade_no" id="trade_no" > </div>																																		
				</form>
