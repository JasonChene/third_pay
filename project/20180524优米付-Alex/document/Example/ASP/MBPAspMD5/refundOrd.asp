...
Call logStr(logFileName, "refund-srcMsg", srcMsg)

tempStr = GetSignString(srcMsg)
signMsg = tempStr
Call logStr(logFileName, "refund-signMsg", signMsg)

sendMsg =srcMsg & "&signMsg=" & Server.URLEncode(signMsg)
Call logStr(logFileName, "refund-sendMsg", sendMsg)

'取得订单退款请求处理结果.
returnMsg = TranscateRequest(sendMsg)
checkMsg = ParseAndChkResp4Refund(returnMsg)
		...
		<tr>
			<td>
				<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
					...
					<tr>
						<td height="30" colspan="2" bgcolor="#6BBE18"><span style="color: #FFFFFF"><a href="index.html"><a href="index.html">感谢您使用支付系统平台</a></span></td>
					</tr>
					<tr>
						<td colspan="2" bgcolor="#CEE7BD">支付系统订单退款请求接口演示：</td>
					</tr>
					<tr>
					...
					<tr>
						<td align="left" height="20">&nbsp;&nbsp;订单退款请求验签结果</td>
