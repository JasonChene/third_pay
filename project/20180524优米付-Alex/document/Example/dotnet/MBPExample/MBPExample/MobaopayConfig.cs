...
namespace com.mobaopay.merchant
{
    ...
    public class MobaopayConfig
    {
        ...
        static MobaopayConfig()
        {
            ...
            mbp_key = "1df5769d24aa1625e0c33e18b6f3f601";

            //支付系统网关地址
            //商户用地址-正式
            mobaopay_gateway = "http://cashier.youmifu.com/cgi-bin/netpayment/pay_gate.cgi";

            //商户接受支付通知地址(商户自己系统的地址)
            merchant_notify_url = "http://localhost/MBPExampleNet/Callback.aspx";

            //商户平台号及商户帐号
            platform_id = "856086110012929";
            merchant_acc = "856086110012929";
