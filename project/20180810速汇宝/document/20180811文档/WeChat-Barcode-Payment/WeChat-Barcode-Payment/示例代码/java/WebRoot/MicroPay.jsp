...
//////////////////////////////////// 请求参数 request parameters //////////////////////////////////////
		...
		if("RSA-S".equals(sign_type)){ //sign_type = "RSA-S"
			...
			调试运行代码之前首先先将商户公钥上传到平台商家后台"公钥管理"（如何获取和上传请查看《密钥对获取工具说明》），不上传商户公钥会导致调试运行代码时报错。
...
<body onLoad="document.dinpayForm.submit();">
  <form name="dinpayForm" method="post" action="https://api.xhbill.com/gateway/api/micropay" >
