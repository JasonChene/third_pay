...
if (_is_mobile() && $scan == 'wy') {
  $agent_type = '2';//网关必填  1：PC端；2：手机；
}elseif (!_is_mobile() && $scan == 'wy') {
  $agent_type = '1';//网关必填  1：PC端；2：手机；
}
...
$card_type = '1'; //网关必填  1：对私借记卡；2：对私贷记卡；3：对公借记卡；
$bank_segment = $_REQUEST['bank_code'];
$user_type = '1';//网关必填  1：个人；2：企业；
