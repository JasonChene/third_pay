<?php
/* *
 *功能：康付通h5支付单笔订单查询接口（目前只能查询距离下单时间12小时以内的）
 *版本：3.1
 *日期：2018-03-20
 *说明：
...
///////////////////////////  初始化接口参数  //////////////////////////////
/**
接口参数请参考康付通扫码支付文档，除了sign参数，其他参数都要在这里初始化
*/
	include_once("./merchant.php");
	
	$merchant_code = "123001002003";//商户号，123001002003是测试商户号，调试时要更换商家自己的商户号！
...
?>
<!-- 以post方式提交所有接口参数到康付通查询网关https://query.tearfxwn.com/query -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	</head>
	<body onLoad="javascript:document.getElementById('queryForm').submit();">
		<form  id="queryForm" action="https://query.tearfxwn.com/query" method="post"  target="_self">
