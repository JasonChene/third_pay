<?php
	...
	$notify_url = "http://www.tearfxwn.com";
...
<html>
	...
	<body onLoad="document.dinpayForm.submit();">
		<form name="dinpayForm" method="post" action="https://api.tearfxwn.com/gateway/api/express" target="_blank">
