...
?>
<!-- 以post方式提交所有接口参数到支付网关https://pay.vsdpay.com/gateway?input_charset=UTF-8 -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	</head>	
	<body onLoad="document.dinpayForm.submit();">
		<form name="dinpayForm" method="post" action="https://pay.vsdpay.com/gateway?input_charset=UTF-8" target="_blank">
