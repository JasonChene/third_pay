...
*/
	...
	$merchant_code = "123001002003";//商户号，1118004517是测试商户号，调试时要更换商家自己的商户号！
...
?>
<!-- 以post方式提交所有接口参数到查询网关https://query.vsdpay.com/query -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	</head>
	<body onLoad="javascript:document.getElementById('queryForm').submit();">
		<form  id="queryForm" action="https://query.vsdpay.com/query" method="post"  target="_self">
