...
public final class Security {
	 ...
	 * @throws AppException
	 */
	public static void verify(String sign, String pubkey, String[] signFields, JSONObject json) throws Exception {
		String signSrc = Security.orgSignSrc(signFields, json);
		boolean bool = RSASignUtil.verify(signSrc, sign, pubkey);
		if (!bool) {
			LOGGER.info("验签失败");
	 ...
	 * @throws
	 */
	public static String sign(String prikey, String[] signFields, JSONObject json) throws Exception {
		String signSrc = Security.orgSignSrc(signFields, json);
		return RSASignUtil.sign(signSrc, prikey);
	}
	...
	public static String countSignMd5(String md5Key, String[] signFields, JSONObject json)
		...
		return MD5Encrypt.getMessageDigest(signSrc);
	}
