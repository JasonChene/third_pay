...
public interface Constants {
	...
	String CHANNELBACKSERIAL = "channelBackSerial";
	...
	String MERCHANTNAMECODE = "merchantNameCode";
	...
	/** 退货订单号 */
	String RETURNORDERID = "returnOrderId";
	...
	String SECRET_FIELD = ",icNumber,expire,dcData,track1,track2,track3,pin,trackInfo,icData,";
	/** 商户采用MD5签名报文 */
	String SIGN_KEY_MD5 = "MD5";
	/** 商户采用RSA签名报文 */
	String SIGN_KEY_RSA = "RSA";
	/** 充值类型 */
	String CHARGETYPE = "chargeType";
	/** 扣款金额 */
	String DEDUCT = "deduct";
	/** 银行卡编码 */
	String CARDNOID = "cardNoId";
	/** 卡密(如:游戏点卡卡密等) */
	...
	/** 通知标识 */
	String NOTICEFLAG = "noticeFlag";
	/** 保险单号 */
	String INSURENO = "insureNo";
	/** 投标人姓名 */
	String INSURENAME = "insureName";
	/** 业务机构编号 */
	String BUSIUNITNO = "busiUnitNo";
	/** 业务职员编号 */
	String BUSIEMPLOYEENO = "busiEmployeeNo";
	/** 商户应用Id */
	String APPID = "appId";
	/** 扩展字段 */
	String EXT = "ext";
