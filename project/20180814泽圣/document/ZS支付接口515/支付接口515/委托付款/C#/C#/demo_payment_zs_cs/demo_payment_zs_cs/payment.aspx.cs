...
namespace demo_payment_zs_cs
{
    public partial class payment : System.Web.UI.Page
    {
        ...
        static string outOrderId = "222212322222222";//必须每次都不同
        static string intoCardName = "李四";
        static string intoCardNo = "6222202000000000";
        static string intoCardType = "2";//必须传2
        static string nonceStr = "123456786464";
        static string totalAmount = "10";//必须正整数
        static string type = "04";//必须04
        static string md5key = "123456ADSEF";
        static string url = "";
        static string notifyUrl = "http://www.baidu.com";


        protected void Page_Load(object sender, EventArgs e)
        {
            //组建签名原文
            string signSrc = "bankCode=" + "" + "&bankName=" + "" + "&intoCardName=" + intoCardName + "&intoCardNo=" + intoCardNo
                   + "&intoCardType=" + intoCardType + "&merchantCode=" + merchantCode + "&nonceStr=" + nonceStr + "&outOrderId=" + outOrderId + "&totalAmount=" + totalAmount + "&type=" + type + "&KEY=" + md5key;
            //签名
