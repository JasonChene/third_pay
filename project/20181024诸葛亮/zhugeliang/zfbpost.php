...
#变更参数设置
$form_url = 'http://www.1qcz.com/pay';//请求地址
$scan = 'zfb';
$data['sdk'] = $pay_mkey_arr[1];//支付宝
...
$signtext = number_format($data['money'], 2, '.', '') . trim($data['record']) . $data['sdk'];
$sign = md5($signtext);
$data['sign'] = $sign;
