...
#固定参数设置
$form_url = 'http://128.1.37.51:9911/code/reqPayOtherWY';
...
$data =array(
  'cpid' => $pay_mid,
  'fee' => number_format($_REQUEST['MOAmount']*100, 0, '.', ''),
  'ip' => getClientIp(),
  'playerid' => $_REQUEST['S_Name'],
...
$data_str = $form_url."?".http_build_query($data);
#curl获取响应值
