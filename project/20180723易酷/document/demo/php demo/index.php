...
$pay_notifyurl = "https://pay.ykpay.net/demo/server.php";   //服务端返回地址
$pay_callbackurl = "https://pay.ykpay.net/demo/page.php";  //页面跳转返回地址
$Md5key = "kxelvb7czjzxbgayziwvoolausevnqig";   //密钥
$tjurl = "https://pay.ykpay.net/Pay_Index.html";   //提交地址
