...
<%
    String AuthorizationURL = "https://pay.ykpay.net/Pay_Index.html";
    ...
    if(Channelid.equals("wx")){
        ...
        String    pay_notifyurl="https://"+request.getRequestURI()+"/Pay/notifyurl.asp";//通知地址
        String    pay_callbackurl="https://"+request.getRequestURI()+"/Pay/Callback.asp";//回调地址
