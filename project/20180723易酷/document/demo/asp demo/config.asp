...
AuthorizationURL = "https://pay.ykpay.net/Pay_Index.html"
'跳转地址
CallbackURL = "https://"&request.ServerVariables("HTTP_HOST")&"/Pay/Callback.asp"
'异步回调地址
notifyurl = "https://"&request.ServerVariables("HTTP_HOST")&"/Pay/notifyurl.asp"
