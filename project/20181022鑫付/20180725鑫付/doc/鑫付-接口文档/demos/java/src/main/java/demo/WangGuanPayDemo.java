...
public class WangGuanPayDemo extends BaseDemo {

    public static Logger logger = LoggerFactory.getLogger(WangGuanPayDemo.class);

    public String payv2(WangGuanPayReqModel reqModel) {
