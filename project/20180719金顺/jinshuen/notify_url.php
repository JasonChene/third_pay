...
$mymoney = number_format($data['deductList.item.payAmt'], 2, '.', ''); //订单金额
$success_msg = $data['deductList.item.payStatus'];//成功讯息
...
#验签方式
$signsuccess = verity($pay_account,$resp_xml,$resp_sign);
