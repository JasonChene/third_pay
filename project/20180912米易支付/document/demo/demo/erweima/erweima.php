...
<head>
    ...
    <title></title>
    <link href="css/wxpay_style.css" rel="stylesheet" media="screen">
...
<div class="body">
    ...
    <div class="mod-ct">
        ...
        <div class="amount" id="money">￥<?php echo $total_fee/100?></div>
        <div class ="paybtn" style = "display: none;">
            <a href="<?php echo $url; ?>" id="alipaybtn" class="btn btn-primary" target="_blank">启动支付宝App支付</a>
            <form action='<?php echo $url; ?>' id="alipayform"></form>
        </div>
        <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
            <div data-role="qrPayImg" class="qrcode-img-area">
                <div class="ui-loading qrcode-loading" data-role="qrPayImgLoading" style="display: none;"></div>
                <div style="position: relative;display: inline-block;">
                    <img  id="show_qrcode" src="https://pan.baidu.com/share/qrcode?w=210&h=210&url=<?php echo $url; ?>" width="210" height="210" style="display: block;"/>
                    
                    <img onclick="$('#use').hide()" id="use" src="img/wxpay/logo_weixin.png" style="position: absolute;top: 50%;left: 50%;width:32px;height:32px;margin-left: -16px;margin-top: -16px"/>
        ...
        <div class ="payweixinbtn" style = "display: none;"><a href="https://pan.baidu.com/share/qrcode?w=210&h=210&url=<?php echo $post['qrcode']; ?>" target="_blank" download id="downloadbtn" class="btn btn-primary">1.先保存二维码到手机</a></div>
        ...
        <div class="time-item" style = "padding-top: 10px">
            <div class="time-item" id="msg"><h1 style="color: red;">为了您及时到帐 请务必付款￥<?php echo $total_fee/100; ?>元</h1> </div>
...
<script type="text/javascript">
    ...
    var myTimer;
    var strcode = '<?php echo $post["qrcode"]; ?>';
    ...
    function checkdata(){
        //check.php  这里可以自己写一个检查订单的接口，这个文件可以查询智能云的查询接口，也可以查询自己系统内的订单
        $.post(
            "/check.php",
            {
                orderid : "",
        ...
        if (isMobile() == 1){
            if (isWeixin() == 1 && istype == 2){
                ...
                if (isWeixin() == 0 && istype == 1){
                    ...
                    //$(location).attr('href', '<?php echo $post["qrcode"]; ?>');
                } else {
