...
if(!empty($data)){
	...
	#验签方式
	$signtext = $data['mch_id'] . $data['time_end'] . $data['out_trade_no'] . $data['ordernumber'] . $data['transtypeid'] . $data['transaction_id'] . $data['total_fee'] . $data['service'] . $data['way'] . $data['result_code'] . $pay_mkey;
