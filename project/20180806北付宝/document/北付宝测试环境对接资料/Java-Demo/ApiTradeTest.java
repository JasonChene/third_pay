...
/**
 * @author xiaoshu
 * @date 2018-01-01 下午00:00
 * @desc API-交易-测试环境版
 **/
public class ApiTradeTest {

    public static void main(String[] args) throws Exception {
        apiPayment();
    }

    public static void apiPayment() throws Exception {
        ...
        String url = "http://39.108.134.13:10017/api/payment/unifiedPay";
        String localurl = "http://localhost:8080/api/payment/unifiedPay";
        String memberNumber = "LXB00000000000001";
        String defrayalType = "ALI_NATIVE";
        String amount = "1";
        String userId = "284596737480288295";
        ...
        mapHead.put("version", "1.0");
        mapHead.put("requestTime", "20180101000000");

        Map<String, String> mapContent = new HashMap<>();
        mapContent.put("defrayalType", defrayalType);
        mapContent.put("memberOrderNumber", System.currentTimeMillis() + "");
        mapContent.put("tradeCheckCycle", "T1");
        mapContent.put("orderTime", "20180101000000");
        mapContent.put("currenciesType", "CNY");
        mapContent.put("tradeAmount", amount);
        mapContent.put("commodityBody", "商品信息");
        mapContent.put("commodityDetail", "商品详情");
        mapContent.put("commodityRemark", "商品备注");
        mapContent.put("notifyUrl", "notifyUrl");
        mapContent.put("returnUrl", "returnUrl");
        mapContent.put("terminalIP", "127.0.0.0");
        mapContent.put("terminalId", "terminalId");
        mapContent.put("userId", userId);
        mapContent.put("attach", "author xiaoshu");
        mapContent.put("remark", "author xiaoshu");
