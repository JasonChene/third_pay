...
String sign = EkaPayEncrypt.EkaPayCardMd5Sign(type,parter,cardno,cardpwd,value,restrict,    //签名
...
//将支付上行结果转换为对应中文说明
String strResult = EkaPayTypeConvert.opstateValueToChn(result); 
//将卡类型转换为中文说明
