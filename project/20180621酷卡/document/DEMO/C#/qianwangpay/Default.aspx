...
<body>
    ...
    <div>
        <form id="frm_payment" action="/qianwangpay/Send.aspx" method="post" class="democss" target="_blank">
        <div>
                ...
                <label>
                    <table width="100%" border="0" cellspacing="0" cellpadiving="0" style="text-align: left;">
                        ...
                        <tr id="tr12">
                            ...
                            <td>
                                <input type="radio" name="rtype" value="1003" />支付宝H5
                            </td>						
                            <td>
                                <input type="radio" name="rtype" value="1004" />微信扫码
                            </td>								
                            <td>
                                <input type="radio" name="rtype" value="994" />微信H5
                            </td>							
                            <td>
                                <input type="radio" name="rtype" value="1006" />银联扫码
                            </td>							
                            <td>
                                <input type="radio" name="rtype" value="1007" />京东扫码
                            </td>							
                            <td>
                                <input type="radio" name="rtype" value="993" />QQ扫码
                            </td>
                            <td>
                            </td>
                        </tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;">
                        <select id="sel_card" name="sel_card" onchange="GetValue(this.id);">
                            ...
                            <option value="13">神州行全国充值卡</option>
