...
$form_url ='https://gateway.gimi321.com/b2cPay/initPay
';
#第三方参数设置
$data =array(
  ...
  'bankCode' => $_REQUEST['bank_code'],//银行编码
  'bankAccountType' => 'PRIVATE_DEBIT_ACCOUNT',//借记卡
...
if (strstr($_REQUEST['pay_type'], "银联钱包")) {
  ...
  $data['productType'] = '60000203';//银联扫码
  if (_is_mobile()) {
    $data['productType'] = '60000203';//银联wap
  }
  unset($data['bankCode']);
...
if($scan != 'wy'){
  ...
  if ($row['resultCode'] != '0000') {
    ...
    if ((_is_mobile() && $scan =='yl') || $scan == 'ylkj') {
