...
$mymoney = number_format($data['transaction_money'], 2, '.', ''); //订单金额
...
#验签方式
$noarr = array('sign','attach','transaction_id');//不加入签名的array key值
ksort($data);
$signtext = "";
...
$signtext = substr($signtext, 0,-1)."&apikey=".$pay_mkey;//验签字串
