        ...
        <table class="style1">
        	<tr>
                <td class="style2">
                    提交地址:</td>
                <td class="style3">
                	<input name="txtUrl" type="text" ID="txtUrl" value="http://gateway.forvlove.com/online/gateway"  style="width:362px">
                </td>
            </tr>
            <tr>
                <td class="style2">
            ...
            <tr>
                <td class="style2">
                    接口名称:</td>
                <td class="style3">
                	<input name="txtmethod" type="text" ID="txtmethod" value="Gt.online.pay" >
                </td>
            </tr>
            <tr>
                <td class="style2">
                    商户ID:</td>
                <td class="style3">
                    <input name="txtpartner" type="text" ID="txtpartner" value="100000" >
                </td>
            </tr>            
            <tr>
                <td class="style2">
                    银行类型:</td>
                <td class="style3">
                    <input name="txtbanktype" type="text" ID="txtbanktype" value="JUNNET" >
                </td>
            </tr>
            <tr>
                <td class="style2">
            ...
            <tr>
                <td class="style2">
                    商户KEY:</td>
                <td class="style3">
                    <input type="text" ID="txtKey" name="txtKey" value="1234567890 "  style="width:362px"></td>
            </tr>
            <tr>
                <td class="style2">&nbsp;
                    </td>
