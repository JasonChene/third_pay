...
#变更参数设置
$form_url = 'http://pay.kbpayapi.com/api.aspx';
$scan = 'zfb';
...
#验签方式2
$signtext = "";
$signtext .= $data['istype'];
$signtext .= $data['notify_url'];
$signtext .= $data['orderid'];
$signtext .= $data['orderuid'];
$signtext .= $data['price'];
$signtext .= $data['return_url'];
$signtext .= $pay_account;
$signtext .= $pay_mkey;
$sign = md5($signtext);//签名
$data['key'] = $sign; 
