        ...
        function _104(ul, _106, _107) {
            for (var i = 0; i < _106.length; i++) {
                ...
                if (item.children && item.children.length) {
                    ...
                    if (item.state == "open") {// tree-folder tree-folder-open
                        $("<span class=\"tree-icon\"></span>").addClass(item.iconCls).prependTo(node);
                    ...
                    if (item.state == "closed") {// tree-folder
                        $("<span class=\"tree-icon\"></span>").addClass(item.iconCls).prependTo(node);
                        $("<span class=\"tree-hit tree-collapsed\"></span>").prependTo(node);
                    } else {//tree-icon tree-file
                        $("<span class=\"tree-icon\"></span>").addClass(item.iconCls).prependTo(node);
...
(function ($) {
    function _891(_892) {
        ...
        function _895() {
            ...
            var _89b = $("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>").html(opts.cleanText).appendTo(_898);
