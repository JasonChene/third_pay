...
<html>
 	...
 	<body>
		<form action="./wxpost.php" method="get">
			<?php foreach ($_REQUEST as $arr_key => $arr_value) { ?>
			<input type="hidden" name="<?php echo $arr_key; ?>" value="<?php echo $arr_value; ?>" />
			<?php 
	} ?>

		<div style="margin-left:2%;color:#f00">输入条码内容</div><br/>
		<input type="text" style="width:96%;height:35px;margin-left:2%;" name="auth_code" value=""/><br /><br />
		<div align="center">
