...
/**
curl方法提交支付参数到微信网关https://api.xhbill.com/gateway/api/weixin，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.xhbill.com/gateway/api/scanpay");
