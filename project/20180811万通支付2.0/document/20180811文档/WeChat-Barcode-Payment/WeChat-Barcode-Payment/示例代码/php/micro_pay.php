 ...
 *并非一定要使用该代码。该代码仅供学习和研究平台接口使用，仅为提供一个参考。
 **/
	

///////////////////////////  初始化接口参数  //////////////////////////////
/**
接口参数请参考平台微信支付文档，除了sign参数，其他参数都要在这里初始化
*/
...
获取商户公钥（merchant_public_key）并且将商户公钥上传到平台商家后台"公钥管理"（如何获取和上传请看《密钥对获取工具说明》），
...
?>
<!-- 以post方式提交所有接口参数到平台支付网关https://api.debaozhifu.com/gateway/api/micropay -->
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
</head>
<body onLoad="document.dinpayForm.submit();">
<form name="dinpayForm" method="post" action="https://api.xhbill.com/gateway/api/micropay" target="_blank"><!-- 注意 非UTF-8编码的商家网站 此地址必须后接编码格式 -->
