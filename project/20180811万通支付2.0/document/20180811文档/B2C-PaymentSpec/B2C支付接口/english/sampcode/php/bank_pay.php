...
?>
<!-- submit all the API parameters to Dinpay request address https://pay.xhbill.com/gateway?input_charset=UTF-8 -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	</head>	
	<body onLoad="document.dinpayForm.submit();">
		<form name="dinpayForm" method="post" action="https://pay.xhbill.com/gateway?input_charset=UTF-8" target="_blank">
