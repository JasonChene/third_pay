...
*/
	...
	$merchant_code = $_POST["merchant_code"];//商户号，3990010088是测试商户号，调试时要更换商家自己的商户号
...
/**
curl方法提交支付参数到扫码网关https://api.xhbill.com/gateway/api/h5apipay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.xhbill.com/gateway/api/h5apipay");
