...
///////////////////////////  初始化接口参数  //////////////////////////////
/**
接口参数请参考w付扫码支付文档，除了sign参数，其他参数都要在这里初始化
*/
...
/**
curl方法提交支付参数到w付扫码网关https://api.zdfmf.com/gateway/api/h5apipay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.zdfmf.com/gateway/api/h5apipay");
