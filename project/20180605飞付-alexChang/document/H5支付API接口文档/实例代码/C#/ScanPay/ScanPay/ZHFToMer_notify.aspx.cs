        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            **/
            ...
            if (trade_no != "")
                ...
                {
                    //使用公钥对返回的数据验签
                    string zhihf_public_key = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCZDDIp0i3Ai7hskWs03M8n9QXrz3FX+KXak/zhy+rO7IBCE2p7mqHgMzj2KTqPfeQyAJoF6WvNy9MT9Vf/MA1mcYpYp9vVXRlLZ9oCFGUHtL2VJJHPzKlit46OGhyU7z/jtWwDuRXqcO76+VPi0/1XOvsyR5lTDKB3LVQA4cPD3wIDAQAB";
                    //将公钥转换成C#专用格式
                ...
                else //RSA验签方法
                {
                    ...
                    {
                        //如果验签结果为true，则对订单进行更新
                        //订单更新完之后必须打印SUCCESS来响应智付服务器以示商户已经正常收到服务器发送的异步数据通知，否则服务器将会在之后的时间内若干次发送同一笔订单的异步数据！！
                        Response.Write("SUCCESS");
                    }
                    else
                    {
