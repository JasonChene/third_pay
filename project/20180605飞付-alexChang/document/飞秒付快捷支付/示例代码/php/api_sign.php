<?php
   ...
   if($sign_status =="2"){
	...
	if($sign_status =="0"&&$card_type=="0"){
		...
		//获取签约号
		$merchant_sign_id = "ba4d40f2819d7aa9";
	...
	//$signStr = $bank_code."input_charset=".$bank_code."&";	
...
<html>
	...
	<body onLoad="document.dinpayForm.submit();">
		<form name="dinpayForm" method="post" action="https://api.zdfmf.com/gateway/api/express" target="_blank">
