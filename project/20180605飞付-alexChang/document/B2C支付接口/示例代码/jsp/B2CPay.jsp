...
///////////////////////////////////  接收请求参数  ////////////////////////////////////
		...
		if("RSA-S".equals(sign_type)){ // sign_type = "RSA-S"
			...
			String merchant_private_key ="MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAOGkgMgoa2psraOZ 5rby3NLASNY R25G2o3R95Gq62PNJSm2MAD07jBQIcvmCkthlI+J5ZxaDWwIbnBY1 L6/E2sZc/xhUkqxMXuNhd5t+ivqWLv0hth2043utJBSRQT1DhmcUytII3z PtWl4P lkdEWj2Qo/HJxSDaPcDl0fmfXus5AgMBAAECgYA7+ShNiwi52bbxM/exiq2MypTR aR+uBBg/3zI1+AGv8Dv7D+oEXG5n6LL+hGkZYRB/onr2 7eTjk4kSEgLhufXXoZes IJ9nXV/C6hiTtvUx6KPvsR1S9z8w4NNxK9ceeeezXaNLk5zuDNTIBU+BxN1bbI+I lb4qjr8GFWj3wcKncQJBAPVyRZYsNCfvBDTxpaoYAW /BIJLMOwUS2D1uPDYUN2Ds Yy0TP7PPwh4U0PhIdfQfC/Qfyj2G3WGvHK0rtYRhJW0CQQDrWD4vrH+vWO0X/CNs 8TvQ+IEdg7LqGXGKiqbiHaGJVPd3g3gSH+Uf ZmZzy+2OB0+BZtFkbw1Fa1A5T2CX aBl9AkEAoFZx1tQxjhS5rsxc6GyeI58J5Fu+AmZ5FEg61SkHtC037G4yowgJSxVW HZtYUo0lhehueRrs6681EHsJLN05UQJALGj/e yGTCrS+MOt8h99RyVJLkxU6GuDo Qxt8+GhdBjxJYn0lmE36f51kMe/GiSmqACI12zz1hScGAXqQIKIdRQJBAJGrHFx7 8jlvta9N1iAPoT78FtX+XH2ZwiRsEHMXc /S+/cYN1zl6Bfn/w/ix1yJUKz9GN6ks UtiRn4kZBd6hCGk=";
...
<body onLoad="document.dinpayForm.submit();">
  <form name="dinpayForm" method="post" action="https://pay.zdfmf.com/gateway?input_charset=<%=input_charset%>" >
