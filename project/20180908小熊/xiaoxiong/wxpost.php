...
#固定参数设置
$form_url = 'http://pay.bearpay.net/bear-pay/pay';
...
$signtext = $data["payWay"].$data["notify_url"].$data["orderId"].$data["money"].$data["return_url"].$pay_mkey.$data["shopId"];
$sign = (md5($signtext));
$data['token'] = $sign;
