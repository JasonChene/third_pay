...
///////////////////////////  初始化接口参数  //////////////////////////////
/**
接口参数请参考赢宝付H5API支付文档，除了sign参数，其他参数都要在这里初始化
*/
	include_once("./merchant.php");
	
	$merchant_code = $_POST["merchant_code"];//商户号，100100200200是测试商户号，调试时要更换商家自己的商户号
    /*echo  $merchant_code;*/
	
	$service_type = $_POST["service_type"];//微信weixin_h5api 
...
/**
curl方法提交支付参数到赢宝付H5API网关https://api.syycwx.com/gateway/api/h5apipay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.syycwx.com/gateway/api/h5apipay");
