<?php
/* *
 *功能：赢宝付h5支付单笔订单查询接口（目前只能查询距离下单时间12小时以内的）
 *版本：3.0
 *日期：2017-10-13
 *说明：
...
*/
	...
	$merchant_code = "100100200200";//商户号，200001001001是测试商户号，调试时要更换商家自己的商户号！
...
?>
<!-- 以post方式提交所有接口参数到赢宝付查询网关https://query.syycwx.com/query -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	</head>
	<body onLoad="javascript:document.getElementById('queryForm').submit();">
		<form  id="queryForm" action="https://query.syycwx.com/query" method="post"  target="_self">
