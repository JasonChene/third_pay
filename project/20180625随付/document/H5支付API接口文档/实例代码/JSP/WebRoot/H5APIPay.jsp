...
//////////////////////////////////// 请求参数  ////////////////////////////////////////////////
		...
		// 支付请求地址
		String reqUrl = "https://api.syycwx.com/gateway/api/h5apipay";
		...
		if("RSA-S".equals(sign_type)){ // sign_type = "RSA-S"			
			...
			代码之前首先先将商户公钥上传到赢宝付商家后台"支付管理"->"公钥管理"（如何获取和上传请查看《密钥对获取工具说明》），不上传商户公钥会导致调试运行代码时报错。
			2)demo提供的merchant_private_key是测试商户号200001001001的商户私钥，请自行获取商户私钥并且替换	*/	
			...
			result= new HttpClientUtil().doPost(reqUrl, reqMap, "utf-8");		 	// 向赢宝付发送POST请求							
		}
