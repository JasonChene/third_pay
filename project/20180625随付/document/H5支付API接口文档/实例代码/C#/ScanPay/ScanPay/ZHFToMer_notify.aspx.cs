...
/**
*功能：赢宝付异步后台通知页面
*场景：当订单支付完毕后赢宝付服务器主动将该笔订单的支付成功数据发送至此页面
*版本：3.1
*日期：2017-03-20
*说明：
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            **/
            ...
            if (trade_no != "")
                ...
                {
                    //使用赢宝付公钥对返回的数据验签
                    string zhihf_public_key = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCP2DxiRIhY5JCpeQDQO9oJJ5iyZ/HviNzTY23N6XEp+P4tacdftFsgwh1DoR4Qa8MI5Lrmb2WTBlFsybLqM9LYLeBvODokFdAdoi+VOjkESJ4Y8XygiP4Sz7osOwB3MkvLVHAK8e2O8U09Sj2MI034snHvnhCpU3ye3BqkzetLkQIDAQAB";
                    //将赢宝付公钥转换成C#专用格式
                ...
                else //RSA验签方法
                {
                    ...
                    {
                        //如果验签结果为true，则对订单进行更新
                        //订单更新完之后必须打印SUCCESS来响应智付服务器以示商户已经正常收到赢宝付服务器发送的异步数据通知，否则赢宝付服务器将会在之后的时间内若干次发送同一笔订单的异步数据！！
                        Response.Write("SUCCESS");
                    }
                    else
                    {
