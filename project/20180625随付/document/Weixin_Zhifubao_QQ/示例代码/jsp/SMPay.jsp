...
//////////////////////////////////// 请求参数  ////////////////////////////////////////////////
		...
		// 支付请求地址
		String reqUrl = "https://api.suifupay.com/gateway/api/scanpay";
		...
		if("RSA-S".equals(sign_type)){ // sign_type = "RSA-S"			
			...
			代码之前首先先将商户公钥上传到快银支付商家后台"支付管理"->"公钥管理"（如何获取和上传请查看《密钥对获取工具说明》），不上传商户公钥会导致调试运行代码时报错。
			...
			result= new HttpClientUtil().doPost(reqUrl, reqMap, "utf-8");		 	// 向快银支付发送POST请求							
		}
		...
		if("RSA".equals(sign_type)){ // 数字证书加密方式 sign_type = "RSA"
			...
			String merPfxPath = webRootPath + "pfx/1111100100101102"; 				// 商家的pfx证书文件路径
