  ...
  <body>
  	<table>
		<tr>
  			<td>
				<form id="queryords">
					<div>商 家 号(merchant_code)：<input Type="text" Name="merchant_code" id="merchant_code" value="100100200200"> * </div>
					...
					<div>商户网站唯一订单号(order_no)：<input Type="text" Name="order_no" id="order_no" > * </div>
					<div>快银支付交易订单号(trade_no)：<input Type="text" Name="trade_no" id="trade_no" > </div>																																		
				</form>
