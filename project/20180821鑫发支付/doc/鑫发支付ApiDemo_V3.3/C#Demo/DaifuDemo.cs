...
namespace testconsole
{
    ...
    {
        private string userId = "XF201808160001";//商户号
        ...
        public string DFSubmit()
        {
            try
            {
                ...
                paramdic.Add("bankAccountName", "XX银行");//开户名
                ...
                string d = paramstr;
                string strResult =HttpPost.SendPost("http://127.0.0.1/api/remit", paramstr, 5000);
        ...
        public string DFCallBackHandle(string strResult)
        {
            ...
            {
                /*
				{"amount":"10000","merchNo":"XF201808160001","msg":"提交成功","orderNo":"201808011041370902x0S","sign":"289B38555EB6A987A320DB4BC12F644E","stateCode":"00"}                    */
