...
public class Test_PayYLCode {
	...
	public static void test() throws Exception{
		...
		Date date = new Date();
		Test_PayYLCode service = new Test_PayYLCode();
		Map reqParam = new HashMap();
		
		String url = "http://192.168.12.15:18000/GW/gw.inter";
		//url = "http://47.90.116.46:18000/GW/gw.inter";
		Map<String, String> map = new HashMap<String, String>();
		map.put("cmd", "PAYYLCODE");//命令字
		...
		logger.info(CipherUtil.decryptDataUTF8(resultMap.get("codeurl"),"123456789"));
	}
	
	public static void xianshang() throws Exception{
		String key = "VcawY01mXm5laB0wQtndl8VbbejgDMbseSpQ76ZmWUJPtKqISjRYWm8GmUWP62d96KVK5gF4IPxWLgSNbOw8NB7eOrjjpezlTkGfYYJmqhwNtxbVBE1L5VNxslONqpnM";
		SimpleDateFormat d = new SimpleDateFormat("yyyyMMddHHmmss");
		Date date = new Date();
		Test_PayYLCode service = new Test_PayYLCode();
		Map reqParam = new HashMap();
		
		String url = "http://47.90.116.46:18000/GW/gw.inter";
		Map<String, String> map = new HashMap<String, String>();
		map.put("cmd", "PAYYLCODE");//命令字
		map.put("version", "2.0");//版本号
		map.put("appid", "mx_test");//商户id
		...
		Map<String, String> resultMap = service.invoke(map, url, key);
     	...
     	System.out.println(CipherUtil.decryptDataUTF8(resultMap.get("codeurl"),"Iu19wfVYvYiGBgBq3rapqeuMEFQA6aqb"));
	}
