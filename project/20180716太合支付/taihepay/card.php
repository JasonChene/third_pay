...
<html>
 	...
 	<body>
		...
		<input type="text" style="width:96%;height:35px;margin-left:2%;" name="acctName" value=""/><br /><br />
		<div style="margin-left:2%;color:#f00">输入身份证</div><br/>
		<input type="text" style="width:96%;height:35px;margin-left:2%;" name="cerdId" value=""/><br /><br />
		<div style="margin-left:2%;color:#f00">输入银行帐号</div><br/>
		<input type="text" style="width:96%;height:35px;margin-left:2%;" name="cardNo" value=""/><br /><br />
		<div align="center">
