...
$notifyurl='http://'.$_SERVER['HTTP_HOST'].'/notify.php';//异步通知地址   
$returnurl='http://'.$_SERVER['HTTP_HOST'].'/return.php';//同步跳转地址   支付完成跳转
$remark='';
...
<body onLoad="document.pay.submit()">
    <form name="pay" action="https://www.247d.cn/apisubmit" method="post">
