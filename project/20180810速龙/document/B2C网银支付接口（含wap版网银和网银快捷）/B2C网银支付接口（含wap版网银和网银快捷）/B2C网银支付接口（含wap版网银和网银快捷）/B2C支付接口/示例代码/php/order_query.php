...
*/
	...
	$merchant_code = "199001002003";//商户号，1118004517是测试商户号，调试时要更换商家自己的商户号！
...
?>
<!-- 以post方式提交所有接口参数到查询网关https://query.islpay.cn/query -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	</head>
	<body onLoad="javascript:document.getElementById('queryForm').submit();">
		<form  id="queryForm" action="https://query.islpay.hk/query" method="post"  target="_self">
