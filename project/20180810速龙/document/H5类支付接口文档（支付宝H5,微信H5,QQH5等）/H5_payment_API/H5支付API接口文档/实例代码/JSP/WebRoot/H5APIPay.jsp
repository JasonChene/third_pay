...
//////////////////////////////////// 请求参数  ////////////////////////////////////////////////
		...
		// 支付请求地址
		String reqUrl = "https://api.islpay.hk/gateway/api/h5apipay";
		// 支付请求返回结果
		String result = null;
		...
		if("RSA-S".equals(sign_type)){ // sign_type = "RSA-S"			
			...
			代码之前首先先将商户公钥上传到速龙商家后台"支付管理"->"公钥管理"（如何获取和上传请查看《密钥对获取工具说明》），不上传商户公钥会导致调试运行代码时报错。
			...
			result= new HttpClientUtil().doPost(reqUrl, reqMap, "utf-8");		 	// 向速龙发送POST请求							
		}
