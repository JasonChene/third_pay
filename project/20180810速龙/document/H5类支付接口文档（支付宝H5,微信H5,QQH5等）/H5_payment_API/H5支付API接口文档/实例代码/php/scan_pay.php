...
*/
	...
	$merchant_code = $_POST["merchant_code"];//商户号，800003004321是测试商户号，调试时要更换商家自己的商户号
...
/**
curl方法提交支付参数到速龙扫码网关https://api.islpay.hk/gateway/api/h5apipay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.islpay.hk/gateway/api/h5apipay");
