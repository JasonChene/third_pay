    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            **/
            ...
            /**
            1)ddbill_public_key，智宝付公钥，每个商家对应一个固定的智宝付公钥（不是使用工具生成的密钥merchant_public_key，不要混淆），
            即为智宝付商家后台"公钥管理"->"智宝付公钥"里的绿色字符串内容
            2)demo提供的ddbill_public_key是测试商户号800003004321的智宝付公钥，请自行复制对应商户号的智宝付公钥进行调整和替换。
            */
