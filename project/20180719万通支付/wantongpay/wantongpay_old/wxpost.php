...
$data = array(
  "uid" => $pay_mid, //商户id
  "price" => number_format($_REQUEST['MOAmount'] * 100, 0, '.', ''), //商品价格（分）
  "pay_type" => '', //100：支付宝；200：微信支付
  "notify_url" => $merchant_url, //用户支付成功后，我们服务器会主动发送一个post消息到这个网址
  "return_url" => $return_url, //跳转的链接
  "orderid" => $order_no, //我们会据此判别是同一笔订单还是新订单。
  "goodsname" => '', //商品名称
  "orderuid" => 'nongfusanquan', //商户自己的用户id
  "key" => '', //必填，验证规则参考验证规则目录
  "user_ip" => getClientIp(), //商户用户的ip
);

#变更参数设置
$form_url = 'http://www.920zf.com:12010/ccpay/ach/pay';//wap提交地址
$scan = 'wx';
$data['pay_type'] = '200';
