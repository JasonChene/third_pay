  ...
  <body>
	<table>
		<tr>
  			<td>
  				<form id="H5APIPay">
					<div>商 家 号(merchant_code)：<input Type="text" Name="merchant_code" id="merchant_code" value="123456789001"> * </div>
					...
					<div>商户订单金额(order_amount)：<input Type="text" Name="order_amount" id="order_amount" value="1"> * </div>		
