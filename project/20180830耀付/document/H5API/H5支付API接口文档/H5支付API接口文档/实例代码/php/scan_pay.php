...
*/
	...
	$merchant_code = $_POST["merchant_code"];//商户号，666007008010是测试商户号，调试时要更换商家自己的商户号
    /*echo  $merchant_code;*/
...
/**
curl方法提交支付参数到扫码网关https://api.shinespay.com/gateway/api/h5apipay，并且获取返回值
*/
	...
	$ch = curl_init();	
	curl_setopt($ch,CURLOPT_URL,"https://api.shinespay.com/gateway/api/h5apipay");
