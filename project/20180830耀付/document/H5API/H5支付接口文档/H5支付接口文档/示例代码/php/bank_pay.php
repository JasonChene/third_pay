...
*/
	...
	$merchant_code = "666007008010";//商户号，666007008010是测试商户号，线上发布时要更换商家自己的商户号！
...
?>
<!-- 以post方式提交所有接口参数到支付网关https://pay.shinespay.com/gateway?input_charset=UTF-8 -->
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	</head>	
	<body onLoad="document.dinpayForm.submit();">
		<form name="dinpayForm" method="post" action="https://pay.shinespay.com/gateway?input_charset=UTF-8" target="_blank">
