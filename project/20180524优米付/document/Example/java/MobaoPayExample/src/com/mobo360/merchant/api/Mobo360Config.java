package com.mobo360.merchant.api;
...
public class Mobo360Config {
	...
	//******************配置商户基本信息
	// 商户ID
	public static String PLATFORM_ID = "856086110012929";
	// 商户帐号
	public static String MERCHANT_ACC = "856086110012929";
	//******************配置商户基本信息***结束
	
	//******************使用MD5签名方式需配置下列参数
	// MD5签名的key值
	public static String MD5_KEY = "1df5769d24aa1625e0c33e18b6f3f601";
	//******************MD5签名方式需配置***结束
	...
	// 通知地址
	public static String MERCHANT_NOTIFY_URL = "http://localhost/MobaoPayExample/callBack.jsp";
	//public static String MERCHANT_NOTIFY_URL = "http://127.0.0.1:8080/MobaoPayExample/callBack.jsp";
	// 支付系统网关
	
	public static String MOBAOPAY_GETWAY = "http://cashier.youmifu.com/cgi-bin/netpayment/pay_gate.cgi";
