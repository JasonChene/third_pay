<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="normalPay.aspx.cs" Inherits="com.mobaopay.merchant.normalPay" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                    ...
                    <tr>
                        <td>
                            <form method="post" action="pay.aspx" target="_blank">
                            <table>
                                <tr>
                                    ...
                                    <td align="left">
                                        <ul class="clearfix">
                                            ...
                                            <li>
                                                ...
                                                <img src="images/zggsyh.gif" alt="工商银行" onclick="onChecked('ICBC');" /></li>
                                            <li>
                                                <input name="bankCode" value="CMB" type="radio" id="CMB" /><img
                                                    src="images/zsyh.gif" alt="招商银行" onclick="onChecked('CMB');" /></li>
                                            <li>
                                                <input name="bankCode" value="CCB" type="radio" id="CCB" /><img
                                                    src="images/zgjsyh.gif" alt="建设银行" onclick="onChecked('CCB');" /></li>
                                            <li>
                                                <input name="bankCode" value="COMM" type="radio" id="COMM" /><img
                                                    src="images/jtyh.gif" alt="交通银行" onclick="onChecked('COMM');" /></li>
                                            <li>
                                                <input name="bankCode" value="ABC" type="radio" id="ABC" /><img
                                                    src="images/zgnyyh.gif" alt="农业银行" onclick="onChecked('ABC');" /></li>
                                            <li>
                                                <input name="bankCode" value="BOC" type="radio" id="BOC" /><img
                                                    src="images/zgyh.gif" alt="中国银行" onclick="onChecked('BOC');" /></li>
                                            <li>
                                            ...
                                            <li>
                                                <input name="bankCode" value="SPDB" type="radio" id="SPDB" /><img
                                                    src="images/pdfzyh.gif" alt="浦发银行" onclick="onChecked('SPDB');" /></li>
                                            <li>
                                                <input name="bankCode" value="CMBC" type="radio" id="CMBC" /><img
                                                    src="images/zgmsyh.gif" alt="民生银行" onclick="onChecked('CMBC');" /></li>
                                            <li>
                                                <input name="bankCode" value="CNCB" type="radio" id="CNCB" /><img
                                                    src="images/zxyh.gif" alt="中信银行" onclick="onChecked('CNCB');" /></li>
                                            <li>
                                                <input name="bankCode" value="CEB" type="radio" id="CEB" /><img
                                                    src="images/zggdyh.gif" alt="光大银行" onclick="onChecked('CEB');" /></li>
                                            <li>
                                                <input name="bankCode" value="HXB" type="radio" id="HXB" /><img
                                                    src="images/hxyh.gif" alt="华夏银行" onclick="onChecked('HXB');" /></li>
                                            <li>
                                            ...
                                            <li>
                                                <input name="bankCode" value="CGB" type="radio" id="CGB" /><img
                                                    src="images/gdfzyh.gif" alt="广发银行" onclick="onChecked('CGB');" /></li>
                                            <li>
                                                <input name="bankCode" value="SDB" type="radio" id="SDB" /><img
                                                    src="images/sfyh.gif" alt="深发银行" onclick="onChecked('SDB');" /></li>
                                            <li>
