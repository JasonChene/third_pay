...
<%
	...
	String r2_TrxId   = formatString(request.getParameter("r2_TrxId"));// API支付交易流水号
	...
	String r7_Uid     = formatString(request.getParameter("r7_Uid"));// API支付会员ID
	...
	if(isOK) {
		...
		if(r1_Code.equals("1")) {
			...
			// 下面页面输出是测试时观察结果使用
			out.println("<br>交易成功!<br>商家订单号:" + r6_Order + "<br>支付金额:" + r3_Amt + "<br>API支付交易流水号:" + r2_TrxId);
		}
	} else {
		out.println("交易签名被篡改!");
	}
