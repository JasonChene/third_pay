...
namespace API.icc
{
	...
	public abstract class Buy
	{
      ...
      //支付的请求地址
      private static string nodeAuthorizationURL = ConfigurationManager.AppSettings["authorizationBankURL"];
      ...
      public static string GetMerId() { return merchantId; }
        ...
        public static void logstr(string orderid, string str,string hmac)
        {
            try
            {
                System.IO.StreamWriter sw = new System.IO.StreamWriter(System.Web.HttpContext.Current.Server.MapPath("BANK.log"), true);
