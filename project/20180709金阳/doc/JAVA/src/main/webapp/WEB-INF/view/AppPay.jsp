        ...
        <div>
            <table class="style1">
                <tr>
                    ...
                    <td class="style3"><input type="text" name="p1_mchtid"
                        value="${p1_mchtid}" /></td>
                </tr>
                <tr>
                    <td class="style2">支付类型:</td>
                    <td class="style3"><select name="p2_paytype" id="p2_paytype">
                ...
                <tr>
                    ...
                    <td class="style3"><select name="p8_signtype" id="p8_signtype">
                        <option value="1" selected="selected">MD5</option>
                    </select></td>
                </tr>
                <tr>
                    <td class="style2">订单金额:</td>
                    <td class="style3"><input type="text" name="p3_paymoney"
                        value="1.10" /></td>
                </tr>
                <tr>
                    <td class="style2">版本号：</td>
                    <td class="style3"><input type="text" name="p7_version"
                        value="v2.8" /></td>
                </tr>
                <tr>
                    <td class="style2">订单号码:</td>
                    <td class="style3"><input type="text" name="p4_orderno"
                        value="${p4_orderno}" /></td>
                </tr>

                <tr>
                    <td class="style2">异步通知地址:</td>
                    <td class="style3"><input type="text" name="p5_callbackurl"
                        value="${p5_callbackurl}" /></td>
                </tr>
                <tr>
                    <td class="style2">同步跳转地址:</td>
                    <td class="style3"><input type="text" name="p6_notifyurl"
                        value="${p5_callbackurl}" /></td>
                </tr>
                <tr>
                    <td class="style2">是否显示收银台:</td>
                    <td class="style3"><select name="p11_isshow" id="p11_isshow">
                ...
                <tr>
                    ...
                    <td class="style3"><input type="text" name="p12_orderip"
                        value="127.0.0.1" /> &nbsp;</td>
                </tr>

                <tr>
                    <td class="style2">备注信息:</td>
                    <td class="style3"><input type="text" name="p9_attach"
                        value="attach" /></td>
                </tr>

                <tr>
                    <td class="style2">分成标识：</td>
                    <td class="style3"><input type="text" name="p10_appname"
                        value="appname" /> &nbsp;</td>
                </tr>
                <tr>
