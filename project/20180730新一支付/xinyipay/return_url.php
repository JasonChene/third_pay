...
#验签方式
$signtext = "version=" . $data['version'] . "&mch_id=" . $data['mch_id'] . "&pay_type=" . $data['pay_type'] . "&total_amount=" . $data['total_amount'] . "&out_trade_no=" . $data['out_trade_no'] . "&notify_url=" . $data['notify_url'] . "&" . $pay_mkey;//验签字串
