...
$reqURL_onLine = "http://www.master-egg.cn/Gateway/ReceiveMoneyRange.aspx";


function getReqHmacString($p0_Cmd,$p1_MerId,$p2_Cur)
{
	include 'merchantProperties.php';
  ...
  #加入支付金额
	//logstr($sbOld,signRSA($sbOld,$privatekey));
  return signRSA($sbOld,$privatekey);

}

function getCallbackHmacString($p0_Cmd,$p1_MerId,$p2_Cur)
{
