...
$status_msg = $data['status'];//成功讯息
$status_code = "0";//文档上的成功讯息
$result_msg = $data['result_code'];//成功讯息
$result_code = "0";//文档上的成功讯息
$sign = $data['sign'];//签名
...
#到账判断
if ($status_msg == $status_code && $result_msg == $result_code) {
	if ($mysign == $sign) {
