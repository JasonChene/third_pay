...
*/
	...
	$notify_url = "http://www.yuanruic.com/Notify_Url.jsp";		
...
?>
<!-- 以post方式提交所有接口参数到智付支付网关https://api.yuanruic.com/gateway/api/micropay -->
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
</head>
<body onLoad="document.dinpayForm.submit();">
<form name="dinpayForm" method="post" action="https://api.yuanruic.com/gateway/api/micropay" target="_blank"><!-- 注意 非UTF-8编码的商家网站 此地址必须后接编码格式 -->
