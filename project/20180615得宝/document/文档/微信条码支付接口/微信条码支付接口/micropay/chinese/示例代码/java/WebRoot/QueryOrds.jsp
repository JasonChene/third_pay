...
//////////////////////////////////// 请求参数 request parameters //////////////////////////////////////
		...
		*/
		...
		if("RSA-S".equals(sign_type)) { //sign_type = "RSA-S"
			...
			调试运行代码之前首先先将商户公钥上传到得宝商家后台"公钥管理"（如何获取和上传请查看《密钥对获取工具说明》），不上传商户公钥会导致调试运行代码时报错。
		...
		if("RSA".equals(sign_type)){ //数字证书加密方式 sign_type = "RSA"
			...
			System.out.println("商家的pfx证书文件路径：" + merPfxPath.length() + " -->" + merPfxPath);
...
<body onLoad="document.dinpayForm.submit();">
  <form name="dinpayForm" method="post" action="https://query.debaozhifu.com/query" >
