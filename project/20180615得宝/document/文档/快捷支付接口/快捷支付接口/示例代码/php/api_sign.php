<?php
	...
	//获取验证码时返回的交易流水号
	$sms_trade_no = "C1086498501";
	
	//手机收到的验证码
	$sms_code = "589804";
	
	$notify_url = "http://www.yuanruic.com";
	
	$order_no = "test007";
	
	$order_amount = "1.0";
	
	$order_time = "2017-11-1 12:12:12";
...
<html>
	...
	<body onLoad="document.dinpayForm.submit();">
		<form name="dinpayForm" method="post" action="https://api.yuanruic.com/gateway/api/express" target="_blank">
			...
			<!--已签约用户传该参数或者下面的encrypt_info,card_type,bank_code三个参数
