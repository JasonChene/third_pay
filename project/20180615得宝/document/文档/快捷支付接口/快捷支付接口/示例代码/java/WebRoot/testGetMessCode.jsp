...
<html>
  ...
  <body>
	<form method="post" action="GetMessCode.jsp" target="_blank">
		...
		<br>手机号(mobile)：<input Type="text" Name="mobile" value="851456665"> *			
		...
		<br>银行卡账号(card_no)：<input Type="text" Name="card_no" value="6865252"> 未签约用户必输
		<br>银行卡户名(card_name)：<input Type="text" Name="card_name" value="大树"> 未签约用户必输
		<br>身份证号(id_no)：<input Type="text" Name="id_no" value="5111223551201"> 未签约用户必输		
