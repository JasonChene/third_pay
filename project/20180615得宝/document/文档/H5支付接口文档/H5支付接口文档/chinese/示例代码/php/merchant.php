...
2）demo提供的merchant_private_key、merchant_public_key是测试商户号200001001888的商户私钥和商户公钥，请商家自行获取并且替换；
...
/**
1)debaozhifu_public_key，公钥，每个商家对应一个固定的公钥（不是使用工具生成的密钥merchant_public_key，不要混淆），
即为商家后台"公钥管理"->"公钥"里的绿色字符串内容,复制出来之后调成4行（换行位置任意，前面三行对齐），
并加上注释"-----BEGIN PUBLIC KEY-----"和"-----END PUBLIC KEY-----"
2)demo提供的debaozhifu_public_key是测试商户号200001001888的智付公钥，请自行复制对应商户号的智付公钥进行调整和替换。
