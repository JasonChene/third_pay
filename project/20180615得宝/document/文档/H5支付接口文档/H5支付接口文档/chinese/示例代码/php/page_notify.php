...
*/	
	...
	$debaozhifuSign = base64_decode($_POST["sign"]);
...
/////////////////////////////   参数组装  /////////////////////////////////
/**
除了sign_type debaozhifuSign参数，其他非空参数都要参与组装，组装顺序是按照a~z的顺序，下划线"_"优先于字母
*/
...
/////////////////////////////   RSA-S验证  /////////////////////////////////
	...
	$flag = openssl_verify($signStr,$debaozhifuSign,$debaozhifu_public_key,OPENSSL_ALGO_MD5);	
