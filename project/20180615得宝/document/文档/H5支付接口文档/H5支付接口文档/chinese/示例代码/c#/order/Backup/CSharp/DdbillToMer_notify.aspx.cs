...
/**
*功能：多异步后台通知页面
*场景：当订单支付完毕后多服务器主动将该笔订单的支付成功数据发送至此页面
*版本：3.0
*日期：2017-04-20
*说明：
    ...
    public partial class DdbillToMer_notify : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            **/
            ...
            /**
        1)ddbill_public_key，多公钥，每个商家对应一个固定的多公钥（不是使用工具生成的密钥merchant_public_key，不要混淆），
        即为多商家后台"公钥管理"->"多公钥"里的绿色字符串内容
        2)demo提供的ddbill_public_key是测试商户号1111110166的多公钥，请自行复制对应商户号的多公钥进行调整和替换。
        */
