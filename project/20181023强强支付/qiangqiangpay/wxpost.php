...
#固定参数设置
$form_url = 'http://pay.qq88pay.com/bear-pay/pay';
...
$signtext = $data["goodsname"] . '$' . $data["payWay"] . '$' . $data["notify_url"] . '$' . $data["orderId"] . '$' . $data["orderUid"] . '$' . $data["money"] . '$' . $data["return_url"] . '$' . $pay_mkey . '$' . $data["shopId"];
$sign = (md5($signtext));
$data['token'] = $sign;
