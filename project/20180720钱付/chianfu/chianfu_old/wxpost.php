...
$form_url = 'http://www.prktszt.com/pay/json';//wap提交地址

#第三方参数设置
$data = array(
  "app_id" => $pay_mid, //商户ID
  "channel" => '',//通道 支付通道代码 alipay表示支付宝 wxpay表示微信支付
  "order_sn" => $order_no,//商户流水号
  "amount" => number_format($_REQUEST['MOAmount'], 0, '.', ''),//支付金额  
  "notify_url" => $merchant_url,//通知地址 
  "nonce_str" => rand(100000,999999),//随机字符串 32位随机字符串
  "sign" => ''//签名
);
#变更参数设置
$scan = 'wx';
