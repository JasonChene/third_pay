...
$data['service'] = 'wxpay.ma';//微信扫码	wxpay.ma
if(_is_mobile()){
    $data['service'] = 'wxpay.wap';//微信手机	wxpay.wap
}
if (strstr($_REQUEST['pay_type'], "京东钱包")) {
  $scan = "jd";
  $payType = $pay_type . "_jd";
  $bankname = $pay_type . "->京东钱包在线充值";
  $data['service'] = 'jdpay.ma';//京东扫码	jdpay.ma
  if(_is_mobile()){
      $data['service'] = 'jdpay.wap';//京东WAP	jdpay.wap
  }
}elseif (strstr($_REQUEST['pay_type'], "QQ钱包") || strstr($_REQUEST['pay_type'], "qq钱包")) {
    $scan = 'qq';
    $payType = $pay_type . "_qq";
    $bankname = $pay_type . "->QQ钱包在线充值";
    $data['service'] = 'qqpay.ma';//QQ钱包扫码	qqpay.ma
    if(_is_mobile()){
        $data['service'] = 'qqpay.wap';//QQ钱包手机	qqpay.wap
    }
}
