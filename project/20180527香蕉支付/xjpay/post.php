...
$data['service'] = 'wangyin.wap';//网关	wangyin.wap
if (strstr($_REQUEST['pay_type'], "银联钱包")) {
  $scan = "yl";
  $payType = $pay_type . "_yl";
  $bankname = $pay_type . "->银联钱包在线充值";
  $data['service'] = 'yinlian.ma';//银联	yinlian.ma
  if(_is_mobile()){
      $data['service'] = 'yinlian.wap';//银联WAP	yinlian.wap
  }
}elseif (strstr($_REQUEST['pay_type'], "银联快捷")) {
    $scan = "ylkj";
    $payType = $pay_type . "_ylkj";
    $bankname = $pay_type . "->银联快捷在线充值";
    $data['service'] = 'wangyin.ma';//快捷	wangyin.ma
}
