...
#设定固定参数
$order_no = $data['out_trade_id']; //订单号
...
#验签方式
$signtext = "pay_memberid=" . $data['pay_memberid'] . "&out_trade_id=" . $data['out_trade_id'] . "&orderstatus=" . $data['orderstatus'] . "&paymoney=" . $data['paymoney'] . $pay_mkey;//验签字串
