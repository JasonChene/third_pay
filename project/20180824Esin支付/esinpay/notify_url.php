...
#设定固定参数
$order_no = $data['P_OrderID']; //订单号
$mymoney = number_format($data['P_FaceValue'], 2, '.', ''); //订单金额
$success_msg = $data['P_ErrCode'];//成功讯息
$success_code = "0";//文档上的成功讯息
$sign = $data['P_PostKey'];//签名
...
#验签方式
$signtext = data['P_UserId'] . '|' . data['P_OrderId'] . '|' . data['P_CardId'] . '|' . data['P_CardPass'] . '|' . data['P_FaceValue'] . '|' . data['P_ChannelId'] . '|' . data['P_PayMoney'] . '|' . data['P_ErrCode'] . '|' . $pay_mkey ;
