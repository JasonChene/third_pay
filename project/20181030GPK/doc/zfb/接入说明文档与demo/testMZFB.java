package com.zfsh.spi.alipay.MZFB;
...
import com.sanwing.spi.constant.AlipayCodeEnum;
import com.sanwing.spi.utils.MD5Utils;
...
public class testMZFB {
	...
	private static final Logger logger = LoggerFactory.getLogger(AliPayUtilsMZFB.class);	
	...
	public static String transferAccount(){
		...
		try {
			...
			String sign =  MD5Utils.doHash("MD5", localMd5).toUpperCase();
