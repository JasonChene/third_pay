 ...
 */
	...
	$api_code = empty($_POST["api_code"]) ? "33396133" : $_POST["api_code"];	//此处填写商户的id;
	$api_key = empty($_POST["api_key"]) ? "879adf264bf0fc038d427a413ede6b03" : $_POST["api_key"];	//此处填写的密钥;			
    ...
    $return_url = 'http://47.75.202.59:10001/paytest/payreturn.php';//支付成功，用户会跳转到这个地址
    $notify_url = 'http://47.75.202.59:10001/paytest/paynotify.php';//通知异步回调接收地址
