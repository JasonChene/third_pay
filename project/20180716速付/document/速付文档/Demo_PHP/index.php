...
<form id="mainForm" class="form-horizontal" action="./paySubmit.php" method="POST">
            ...
            <div class="span10 offset1">
                ...
                <div class="low-half-radius-border" style="padding-top: 10px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls" style="margin-left: 110px; padding-top: 5px;">
                            <span style="color: red;"><strong><?=$orderAmount?>元</strong></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <input type="hidden" name="product_name" value="<?=$productName?>"><!--商品名称-->
    <input type="hidden" name="product_num" value="<?=$productNum?>"><!--商品数量-->
    <input type="hidden" name="order_no" value="<?=$orderNo?>"><!--订单号-->
    <input type="hidden" name="order_amount" value="<?=$orderAmount?>"><!--订单金额-->
    <input type="hidden" name="customer_phone" value="<?=$customerPhone?>"><!--付款人联系电话-->
    <input type="hidden" name="receive_address" value="<?=$receiveAddress?>"><!--收货地址-->
    <input type="hidden" name="return_params" value="<?=$returnParams?>"><!--回传参数-->
    <input type="hidden" name="bank_code" value=""><!--银行编码-->
	<input type="hidden" name="inform_url" value="127.0.0.1/pay"><!--银行编码-->
