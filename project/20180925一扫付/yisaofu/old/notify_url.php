...
$recievedata = explode('|',$input_data);
$str = $recievedata[1];
$res=json_decode($str,1);//json回传资料
...
#验签方式
// write_log("signtext=".$str);
$signtext = base64_encode($str);
$signtextmd5 = md5($signtext);
$mysign = strtoupper(md5($pay_mkey . $signtextmd5));//签名
