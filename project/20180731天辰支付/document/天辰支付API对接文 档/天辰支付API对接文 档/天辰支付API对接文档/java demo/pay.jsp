...
<%
    String AuthorizationURL = "https://api.8562662.com/Pay_Index.html";
    String merchantId = "10001";
    String keyValue = "h4xxl2mqwzn7pogpk2vs1tbijrm43ic5" ;
    ...
    if(Channelid.equals("wx")){
        ...
        String    pay_memberid=merchantId;//??id
        String    pay_orderid=generateOrderId();//20???? ???+6????????
        String    pay_applydate=generateTime();//yyyy-MM-dd HH:mm:ss
        String    pay_notifyurl="http://"+request.getRequestURI()+"/Pay/notifyurl.asp";//????
        String    pay_callbackurl="http://"+request.getRequestURI()+"/Pay/Callback.asp";//????
        String    pay_amount=Moneys;
        String    pay_attach="";
        String    pay_productname="100?????";
