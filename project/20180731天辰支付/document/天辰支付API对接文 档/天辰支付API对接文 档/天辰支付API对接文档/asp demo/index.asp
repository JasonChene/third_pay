...
<table width="68%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
        ...
        </table>支付金额<input type="text" name="Moneys" value="" />
</td>
    </tr>
    <tr>
      <td height="36" colspan="2" align="center"><input type="submit" name="submit2" value="提交订单" onClick="return checkMoney()" /></td>
    </tr>
  </table>
</form>
</body>
