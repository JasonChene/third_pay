  ...
  <div class="container" style="padding-top:70px;">
    <div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
      <div class="panel panel-primary">
        ...
        <form name=alipayment id=form1 action=epayapi.php method=post>
          	<input type="hidden" name="type" id="type" value=""></input>
            <div class="input-group">            
              <span class="input-group-addon"><span class="glyphicon glyphicon-barcode"></span></span>
               <input size="30"  maxlength="12" name="WIDout_trade_no" value="<?php echo order_no(); ?>"  class="form-control" placeholder="商户订单号" />
               </div>
            <br/>
            <div class="input-group">
...
<div class="btn-group btn-group-justified" role="group" aria-label="...">
  <div class="btn-group" role="group">
    <input type="button" value="支付宝" class="btn btn-primary" onclick="gopay('2')"></input>
  </div>
  <div class="btn-group" role="group">
    <input type="button" value="QQ" class="btn btn-success" onclick="gopay('3')"></input>
  </div>
  <div class="btn-group" role="group">
    <input type="button" value="微信" class="btn btn-info" onclick="gopay('1')"></input>
  </div>
</div>
<p style="text-align:center"><br>&copy; 技术支持 <a href="http://www.xingbao123.com">易支付</a>/<a href="http://platform.xingbao123.com">商户后台</a>/<a href="http://platform.xingbao123.com/admin.php">管理后台</a></p></div>
</center> </div>
          </form>
        </div>
      </div>      
