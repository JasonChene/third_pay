...
<%
    ...
    String merchant_user_id = "1";                          //商户平台会员ID（建议用数据库中对应的会员数据记录的自增列（mysql）或序列(oracle)的值）
...
<form action="<%=url%>" method="get" id="form">
    ...
    <div class="center">商户平台会员ID：<input name="merchant_user_id" value="<%=merchant_user_id%>"/></div>
