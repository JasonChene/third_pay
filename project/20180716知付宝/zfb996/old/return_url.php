...
$arraydata=json_decode(base64_decode($alldata,true),true);
...
#验签方式
$signtext = "appid=".$data['appid']."&out_trade_no=".$data['out_trade_no']."&trade_no=".$data['trade_no']."&money=".$data['money']."&key=".$pay_mkey;
