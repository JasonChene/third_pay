<?php
require_once("lib/class.lianruipay.php");
?>
...
$html	.= '<tbody>';
$html	.= '<tr class="title">';
$html	.= '	<td colspan="2"><img src="images/jk_logo.gif" /><br/>phpeka demo 1.0 <br/>联瑞接口版本:v2.1<br/>网银支付版本:v2.0</td>';
$html	.= '</tr>';
$html	.= '<tr>';
...
$option="";
foreach($obao_restrict as $code => $text )
{
	if($code==="0")
	{
