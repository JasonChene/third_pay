...
class bankpay{
	...
	* 联瑞网银支付接口URL
	*/
	const obao_bank_url	= 'http://zf.lianruipay.com/chargebank.aspx';
	...
	*/
	public function send(){
		...
		//最终url
		$url	= bankpay::obao_bank_url . "?" . $url . "&sign=" .$sign. "&hrefbackurl=". $this->hrefbackurl;				
