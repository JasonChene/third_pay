...
String sign = lianruipaypayEncrypt.lianruipaypayBankMd5Sign(type,parter,value,orderid,callbackurl,md5key);//签名
String payerIp = request.getRemoteAddr();													//玩家ip
%>
	<div>联瑞支付网银接口演示(上行)</div>
