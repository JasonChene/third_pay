...
if(!Integer.valueOf(totalvalue).equals(sValue)){
	...
	String sign = lianruipaypayEncrypt.lianruipaypayCardMultiMd5Sign(type,parter,cardno,cardpwd,value,totalvalue,restrict,    //签名
