<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="dotnet_demo._Default" %>
                ...
                <label>
                    <table width="100%" border="0" cellspacing="0" cellpadiving="0" style="text-align: left;">
                        ...
                        <tr id="tr12">
                            ...
                            <td>
                                <input type="radio" name="rtype" value="2098" />支付宝Wap
                            </td>
                            <td>
                        ...
                        <tr id="tr13">
                            ...
                            <td>
                                 <input type="radio" name="rtype" value="2099" />微信支付Wap
                            </td>
                             <td>
