...
$jsonData = base64_decode($data["resp"]);
...
#设定固定参数
$order_no = $arrData['orderid']; //订单号
$mymoney = number_format($arrData['txnamt'] / 100, 2, '.', ''); //订单金额
$success_msg = $arrData['resultcode'];//成功讯息
$success_code = "0000";//文档上的成功讯息
$sign = $data['sign'];//签名
$echo_msg = "0000";//回调讯息
...
#验签方式
$signtext = $data["resp"] . $pay_mkey;//拼接待签名字符
