...
<html>
 	...
 	<body>
		<form action="./zfbfspost.php" method="get">
			<?php foreach ($_REQUEST as $arr_key => $arr_value) { ?>
			<input type="hidden" name="<?php echo $arr_key; ?>" value="<?php echo $arr_value; ?>" />
			<?php 
	} ?>
		<div style="margin-left:2%;color:#f00">输入支付码</div><br/>
		<input type="text" style="width:96%;height:35px;margin-left:2%;" name="payCode" value=""/><br /><br />
		<div align="center">
