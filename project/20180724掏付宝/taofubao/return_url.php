...
if(!empty($data)){
	...
	$conn = '&';
	$signtext = "";
	$signtext .= 'customerid'.$betcon.$data['customerid'].$conn;
	$signtext .= 'status'.$betcon.$data['status'].$conn;
	$signtext .= 'sdpayno'.$betcon.$data['sdpayno'].$conn;
	$signtext .= 'sdorderno'.$betcon.$data['sdorderno'].$conn;
	$signtext .= 'total_fee'.$betcon.$data['total_fee'].$conn;
	$signtext .= 'paytype'.$betcon.$data['paytype'].$conn;
