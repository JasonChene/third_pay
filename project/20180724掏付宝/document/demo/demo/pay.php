...
$notifyurl='http://'.$_SERVER['HTTP_HOST'].'/docs/demo/notify.php';
$returnurl='http://'.$_SERVER['HTTP_HOST'].'/docs/demo/return.php';
$remark='';
...
<body onLoad="document.pay.submit()">
    <form name="pay" action="http://www.taodll.cn/gateway" method="get">
