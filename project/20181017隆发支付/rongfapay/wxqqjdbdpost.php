...
elseif (strstr($_REQUEST['pay_type'], "百度钱包")) {
  $scan = 'bd';
  $data['netwayType'] = 'BAIDU';
} 
else {
  if (strstr($_REQUEST['pay_type'], "反扫")) {
    if(_is_mobile()){
      $scan = 'wx';
      $data['netwayType'] = 'WX_AUTH_CODE_WAP';
    }else{
      $scan = 'wx';
      $data['netwayType'] = 'WX_AUTH_CODE';
    }
  }else{
    if(_is_mobile()){
      $scan = 'wx';
      $data['netwayType'] = 'WX_WAP';
    }
    else{
      $scan = 'wx';
      $data['netwayType'] = 'WX';
