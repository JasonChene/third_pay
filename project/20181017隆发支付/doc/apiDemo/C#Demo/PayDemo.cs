...
namespace testconsole
{
    public class PayDemo
    {
        ...
        {
            string payurl = "http://47.94.6.240:9003/api/pay";//请求地址
            string userId = "LFP201808250000";//商户ID
            string orderNo = dateStr + "test";
            Dictionary<String, String> paramdic = new Dictionary<String, String>();
            paramdic.Add("merchNo", userId);
            paramdic.Add("netwayType", "WX");
            paramdic.Add("randomNo", new Random().Next(1000, 9999).ToString());//随机号 可以重复
            paramdic.Add("orderNo", orderNo);//订单交易号
            paramdic.Add("amount", "100");//订单金额 单位分
            paramdic.Add("goodsName", "家具配套");//商品名称
            ...
            try
            {
                /*
                 data={“key1":"val1","key2":"val2","sign":"1111111111111"}
                    ...
                    sign=MD5(metaSign)
                 */
                //strResult="{\"merchNo\":\"XF201806040000\",\"msg\":\"提交成功\",\"orderNo\":\"20180801102543215VCqeRK\",\"qrcodeUrl\":\"https://qr.alipay.com/bax04012imdorbvgrls78018\",\"sign\":\"96DCC7A5140BF58CD02D18D518B770E9\",\"stateCode\":\"00\"}";
        ...
        private string PaySelect()
        {
            try
            {
                ...
                string netwayType = "ZFB";
                string userId = "HFB201808250000";
                Dictionary<String, String> paramdic = new Dictionary<String, String>();
                paramdic.Add("merchNo", userId);
                paramdic.Add("netwayType", netwayType);
