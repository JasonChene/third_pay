...
$data = array(
  "uid" => $pay_mid, //商户号
  "price" => number_format($_REQUEST['MOAmount'], 2, '.', ''),//订单金额：单位/元
  "order_id" => $order_no,//商户流水号
  "type" => '',//支付方式
...
$form_url = 'http://zfb.ttzdj.cn/Home/Pay/payForJson';
$scan = 'zfb';
$data['type'] = '2';
...
$signtext = $merchant_url . $order_no . $data['price'] . $return_url . $pay_mkey . $data['type'] . $pay_mid;
$sign = md5($signtext);
$data['key'] = $sign; 
