...
if(!empty($data)){
	...
	#RSA解密方式
	$signtext = 'merchantCode=' . $data['merchantCode'] . '&orderNo=' . $data['orderNo'] . '&amount=' . $data['amount'] . '&successAmt=' . $data['successAmt'] . '&payOrderNo=' . $data['payOrderNo'] . '&orderStatus=' . $data['orderStatus'] . '&extraReturnParam=' . $data['extraReturnParam'];//验签字串
