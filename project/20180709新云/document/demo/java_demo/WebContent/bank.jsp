...
//支付接口地址
String api_url = 	StringUtils.formatString(obaopayConfig.getInstance().getValue("bank_url")); 	
/*
* 订单参数
*/
...
String sign = obaopayEncrypt.obaopayBankMd5Sign(type,parter,value,orderid,callbackurl,md5key);//签名
String payerIp = request.getRemoteAddr();													//玩家ip
%>
	<div>新云支付支付网银接口演示(上行)</div>
		<form name="obaopay" action='<%=api_url%>' method='GET' target="_blank">
