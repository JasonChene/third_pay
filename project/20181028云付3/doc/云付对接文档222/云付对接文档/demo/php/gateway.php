...
$callback_url = 'http://47.105.34.228/callback_url.php';
//支付成功后自动跳转url
$success_url = 'http://47.105.34.228/';
//支付失败或者超时后跳转url
$error_url = 'http://47.105.34.228/';
...
<body>
<form action="http://47.105.34.228/gateway/index/checkpoint.do" method="post" id="frmSubmit">
