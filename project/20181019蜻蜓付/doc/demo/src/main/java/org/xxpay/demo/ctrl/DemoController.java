...
public class DemoController {
    ...
    public JSONObject create(HttpServletRequest request) {
        ...
        JSONObject retObj = createPayOrder(type, this.mchId, this.privateKey, this.appId, productId, amount, subject, body, notifyUrl);
     ...
     * @return
     */
    JSONObject createPayOrder(String type, Long mchId, String key, String appId, String productId, String amount, String subject, String body, String notifyUrl) {
