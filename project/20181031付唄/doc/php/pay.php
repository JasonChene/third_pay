...
$bankcode="";
$notifyurl='http://'.$_SERVER['HTTP_HOST'].'/upload/php/notify.php';
$returnurl='http://'.$_SERVER['HTTP_HOST'].'/upload/php/return.php';
$remark=$_POST['remark'];
...
<body onLoad="document.pay.submit()">
    <form name="pay" action="http://www.pd55.top/apisubmit" method="post">
