...
public class Payment {
	...
	public static void main(String[] args) {
		 ...
		 paramMap.put("orderPrice", "3.03");							//金额
		 
		 String orderNo = String.valueOf(System.currentTimeMillis()); 	//订单编号
		 paramMap.put("outTradeNo", orderNo);
		 
//		 paramMap.put("productType", "10000202");//微信DO WAP
//		 paramMap.put("productType", "10000203");//微信T0 WAP
		 paramMap.put("productType", "10000201");//微信T1 WAP
//
//		 paramMap.put("productType", "20000202");//支付宝D0 WAP
//		 paramMap.put("productType", "20000203");//支付宝T0 WAP
//		 paramMap.put("productType", "20000201");//支付宝T1 WAP
